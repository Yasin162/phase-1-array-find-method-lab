...
//    if (record) {const sadReality = record.find(obj => 
//         {obj.result = 'W'
//         return obj.year})}
//         else if (record) {record.find(win => {win.result === 'W' 
//     return win.result})}
// }
// results = function(record)  {
//   return (record.results==='W')
// }
// function superbowlWin(record) {
// const obj = record.find(results)
// if (obj === 'undefined') {return ('undefined')}
// else {
// return obj.year;
// }
//}
// const obj = record.find(superbowlWin).year;
// function superbowlWin (record) {
...
function superbowlWin(record) {
  ...
  //console.log("SEE ME!!! IM HERE!!!: ", obj.year)
